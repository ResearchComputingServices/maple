...
class TestModel(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.topics = [Topic(name=topic_name, dot_summary= dot_summary) for topic_name, dot_summary in zip(self.topic_names, self.topic_dot_summary)]
    ...
    def test_model_equality(self):
        ...
        self.assertEqual(self.model1.to_dict(include_topic = True), self.model2.to_dict(include_topic = True))
...
class TestModelIteration(unittest.TestCase):
    ...
    def test_fields(self) -> None:
        ...
        self.assertEqual(self.model_iteration_article_trained, self.model_iteration.article_trained)
        self.assertEqual(self.model_iteration_article_classified, self.model_iteration.article_classified)
    ...
    def test_to_dict(self):
        ...
        for key in ['model_iteration_name',
            ...
            self.assertTrue(dictname in model_iteration_dict, f'missing key {dictname}')
            self.assertEqual(model_iteration_dict[dictname], getattr(self.model_iteration, dictname))
    
    def test_to_dict_with_models(self):
        model_iteration_dict = self.model_iteration.to_dict(include_model = True, include_topic=True)
